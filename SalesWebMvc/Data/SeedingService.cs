...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Antonio Junior", "jr@gmail.com", new DateTime(1988, 9, 1), 7000.0, d1);
            Seller s2 = new Seller(2, "Beyonce Queen", "bey@gmail.com", new DateTime(1998, 7, 21), 3000.0, d2);
            Seller s3 = new Seller(3, "Camilla Cabelo", "camila@gmail.com", new DateTime(2000, 8, 12), 2000.0, d3);
            Seller s4 = new Seller(4, "Jennifer Laurence", "jeniffer@gmail.com", new DateTime(1980, 4, 11), 5000.0, d4);
            Seller s5 = new Seller(5, "Rihanna Barbabos", "rihanna@gmail.com", new DateTime(1970, 3, 6),4500.0, d4);
            Seller s6 = new Seller(6, "Lauren Jaregui", "lauren@gmail.com", new DateTime(1982, 2, 7), 5500.0, d1);
